...
***************************************************************************** */
        ...
        const script_forms = document.querySelectorAll(".book-transfer__form");
        ...
        async function sendMessage(form) {
            ...
            if (formData) {
                ...
                if (response.ok) {
                    form.reset();
                    document.getElementById("popup").classList.remove("popup_show");
                    ...
                    alert("Дякуємо за довіру😉, невдовзі з вами звяжеться наш працівник📱");
                    setTimeout((function() {
                    ...
                    document.body.style.paddingRight = "0px";
                    document.querySelector("header").style.paddingRight = "0px";
                    alert("Упс виникла помилка😵, звяжіться з нами за допомогою VIBER WHATSAPP чи TELEGTRAM, натиснувши на кнопку з відповідним зображенням ⬇️");
                }
            }
        }
        document.querySelectorAll("[data-thanks]").forEach((function(element) {
            element.addEventListener("click", (function(event) {
                event.preventDefault();
                var href = this.getAttribute("href");
                var thanksPage = this.getAttribute("data-thanks");
                setTimeout((function() {
